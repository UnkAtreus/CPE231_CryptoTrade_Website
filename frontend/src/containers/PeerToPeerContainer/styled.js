...
// Wrapper
// ============================================================
export const PeerToPeerStyled = styled.div`
  /* Parent styles
  ------------------------------- */
...
export const PeerToPeerType = styled.div`
  height: 340px;
  width: 100%;
  border-radius: ${VARIABLES.BORDER_RADIUSES.SMALL};
  background-color: ${VARIABLES.COLORS.BACKGROUND_2};
...
export const PeerToPeerTypeContainer = styled.div`
  display: flex;
...
export const PeerToPeerHistory = styled.div`
  height: 296px;
  width: 100%;
  border-radius: ${VARIABLES.BORDER_RADIUSES.SMALL};
  background-color: ${VARIABLES.COLORS.BACKGROUND_2};
